...
@section('content')
    <div class="d-flex justify-content-between">
        ...
        <div class="me-2">
            <a href="{{ route('admin.about.create') }}" class="btn btn-primary btn-sm">{{ __('translation.menu.add') }}</a>
        </div>
    </div>
    <table id="table" class="table table-striped">
        <thead>
            <tr>
                ...
                <th>{{ __('translation.about.message') }}</th>
        ...
        let table = $('#table').DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (colValue) {
                        let urlAddCoin = '{{ route('admin.about.edit', ':id') }}';
                        urlAddCoin = urlAddCoin.replace(':id', colValue);

                        let urlDelete = '{{ route('admin.about.delete', ':id') }}';
